          ...
          <div class="card-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active text-bold-primary-color" id="basic-tab" data-bs-toggle="tab" data-bs-target="#basic-tab-pane"
              ...
              <li class="nav-item" role="presentation" id="bundle-items-tab-nav" style="display:none;">
                <button class="nav-link text-bold-primary-color" id="bundle-items-tab" data-bs-toggle="tab" data-bs-target="#bundle-items-tab-pane"
                  type="button" role="tab" aria-controls="bundle-items-tab-pane"
                  aria-selected="false">{{ __('panel/product.bundle_items_tab') }}</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link text-bold-primary-color" id="translation-tab" data-bs-toggle="tab" data-bs-target="#translation-tab-pane"
                  type="button" role="tab" aria-controls="translation-tab-pane"
                  aria-selected="false">{{ __('panel/product.product_description') }}</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link text-bold-primary-color" id="specification-tab" data-bs-toggle="tab"
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link text-bold-primary-color" id="addition-tab" data-bs-toggle="tab" data-bs-target="#addition-tab-pane"
                  type="button" role="tab" aria-controls="addition-tab-pane"
                  aria-selected="false">{{ __('panel/product.extend_information') }}</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link text-bold-primary-color" id="seo-tab" data-bs-toggle="tab" data-bs-target="#seo-tab-pane" type="button"
                  role="tab" aria-controls="seo-tab-pane" aria-selected="false">{{ __('panel/product.seo') }}</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link text-bold-primary-color" id="relation-tab" data-bs-toggle="tab" data-bs-target="#relation-tab-pane"
