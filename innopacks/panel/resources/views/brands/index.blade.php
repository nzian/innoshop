...
<a href="{{ panel_route('brands.create') }}" class="btn btn-primary">
      ...
      <table class="table align-middle rounded border">
        <thead>
          <tr>
            ...
            <td class="text-white">{{ __('panel/brand.logo') }}</td>
            <td class="text-white">{{ __('panel/brand.name') }}</td>
            <td class="text-white">{{ __('panel/brand.first') }}</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ $item->url }}" class="text-decoration-none text-bold-primary-color" target="_blank">
                {{ $item->name ?? '' }}
              </a>
            </td>
            <td>{{ $item->first }}</td>
            ...
            <td>
              @include('panel::shared.list_switch', [
                'value' => $item->active,
                'url' => panel_route('brands.active', $item->id)
              ])
            </td>
            <td>
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $item->id }}">
                  <li>
                    <a class="dropdown-item" href="{{ panel_route('brands.edit', [$item->id]) }}">
              ...
              <form ref="deleteForm" action="{{ panel_route('brands.destroy', [$item->id]) }}" method="POST" style="display:none;">
                @csrf
                @method('DELETE')
              </form>
            </td>
